...
| Task | Status | Summary |
|---|---|---|
| 0 | completed | Persistent project-memory protocol, validator, and tests |
| 1 | completed | Versioned processing profiles, reviewed |
| 2 | in_progress | Configurable cleaning and structural units; quality blockers remain |
| 3 | pending | Canonical general, resume, and parent-child chunking |
| 4 | pending | SQLite profile migration and persistence |
| 5 | pending | Hierarchy-aware ingestion and retrieval |
| 6 | pending | Dify-style Knowledge Studio controls |
| 7 | pending | Retrieval Lab consistency and diagnostics |
| 8 | pending | Migration, integration, and documentation |
