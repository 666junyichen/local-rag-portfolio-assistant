...
export default function ArchitecturePage() {
  return <div className="pageFrame">
    ...
    <div className="modeGrid">
      ...
      <section className="modePanel"><div className="modeIcon cloud"><Cloud size={20}/></div><h2>Cloud public mode</h2><p>Next.js 和 Vercel Functions 为招聘者提供可分享、可验证的公开问答。</p><div className="flow"><span>Curated JSON</span><ArrowRight/><span>Gemini embeddings</span><ArrowRight/><span>Atlas Vector Search</span><ArrowRight/><span>Gemini</span></div><ul><li><CheckCircle2/>Streaming chat and citations</li><li><CheckCircle2/>Read-only Retrieval Lab</li><li><Database/>Public collection is isolated</li></ul></section>
    </div>
